...
1. Download [`Loadout_0.6.0_aarch64.dmg`](https://github.com/loadout-io/loadout/releases/latest).
...
```bash
shasum -a 256 ~/Downloads/Loadout_0.6.0_aarch64.dmg
spctl --assess --type open --context context:primary-signature -v ~/Downloads/Loadout_0.6.0_aarch64.dmg
```
