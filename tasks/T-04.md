...
check: cargo test --test it claude_argv_transport::
...
check: cargo test --test it claude_argv_policy::
...
check: cargo test --test it claude_unknown_events::
...
check: cargo test --test it claude_completion::
...
check: cargo test --test it claude_rate_limit::
...
check: cargo test --test it claude_session_process:: -- --include-ignored
...
check: cargo test --test it claude_cancel_escalation:: -- --include-ignored
...
src-tauri/tests/it/claude_unknown_events.rs
src-tauri/tests/it/claude_completion.rs
src-tauri/tests/it/claude_rate_limit.rs
