...
check: cargo test --test it skills_ingest_injection::
...
check: cargo test --test it skills_ingest_clean::
...
check: cargo test --test it skills_ingest_no_exec::
...
check: cargo test --test it skills_ingest_fetch_policy::
...
check: cargo test --test it skills_ingest_scanner::
...
check: cargo test --test it skills_ingest_selftest::
...
src-tauri/tests/it/skills_ingest_injection.rs
src-tauri/tests/it/skills_ingest_clean.rs
src-tauri/tests/it/skills_ingest_no_exec.rs
src-tauri/tests/it/skills_ingest_fetch_policy.rs
src-tauri/tests/it/skills_ingest_scanner.rs
src-tauri/tests/it/skills_ingest_selftest.rs-->
