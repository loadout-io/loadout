...
Czego **nie** posiadasz: `src-tauri/src/skills/place.rs` i `mod.rs` (T-18), `src-tauri/Cargo.toml`,
...
(`harness/gate.py`, `NOT_A_REAL_RED` — test, który się nie kompiluje, nie jest czerwony).
