...
- Wiersz mówi źródło, warunek, prawdziwą nazwę workflow i jeden stan. Ma najwyżej cztery
  elementy z tekstem oraz jeden przełącznik.
...
i staje na ekranie. Wiersz mieści się w suficie gęstości i nie ma martwej kontrolki.
...
Uzbrojony mówi, że czuwa i jeszcze nic nie uruchomił; busy mówi, że zachował sprawę; odmowa jest
słowo w słowo; accepted podaje workflow i czas receipt. Cztery zdania są parami różne.
...
Listowanie prawdziwych plików zwraca slug, source, condition, workflow, enabled i nazwany problem,
ale klucz nie występuje w serializacji ani `Debug`. Ukryte pliki stanu nie są konfiguracjami.
...
drugiego startu. Kontrola dowodzi, że ręczny Start nadal sam wybija UUID.
