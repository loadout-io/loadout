...
check: cargo test --test it handoff_written_after_step::
...
check: cargo test --test it handoff_reaches_next_prompt::
...
check: cargo test --test it handoff_index_for_fan_in::
