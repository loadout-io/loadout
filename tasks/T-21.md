...
check: cargo test --test it limits_dial_raises::
...
check: cargo test --test it limits_dial_lowers::
...
check: cargo test --test it limits_pause_is_run_level::
...
check: cargo test --test it limits_resume_at_reset::
...
check: cargo test --test it limits_rate_limit_status::
...
check: cargo test --test it limits_suggested_at_once::
...
src-tauri/tests/it/limits_dial_raises.rs
src-tauri/tests/it/limits_dial_lowers.rs
src-tauri/tests/it/limits_pause_is_run_level.rs
src-tauri/tests/it/limits_resume_at_reset.rs
src-tauri/tests/it/limits_rate_limit_status.rs
src-tauri/tests/it/limits_suggested_at_once.rs-->
