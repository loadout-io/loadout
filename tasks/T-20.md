...
check: cargo test --test it recovery_boot_guard::
...
check: cargo test --test it recovery_reap_targets::
...
check: cargo test --test it recovery_status_table::
...
check: cargo test --test it recovery_asks_never_resumes::
...
check: cargo test --test it recovery_proof_of_death::
...
check: cargo test --test it recovery_unreadable_rows::
...
src-tauri/tests/it/recovery_proof_of_death.rs
