...
7. **Dysk pierwszy, ekran drugi.** Create/Edit/Delete zmienia listę dopiero po potwierdzeniu
   Rusta. Edycja niesie zredagowaną migawkę oczekiwanego pliku; ręczna zmiana między odczytem
   i zapisem daje nazwaną odmowę, nie ciche nadpisanie.
...
klucz, `Some` zastępuje go, tryb pliku zostaje, a zmieniona ręką migawka daje odmowę i bajty
pozostają identyczne. Żaden zwrot, `Display`, `Debug` ani serializacja nie niesie obu
