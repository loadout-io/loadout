...
check: cargo test --test it run_reaches_the_pump::
...
check: cargo test --test it run_commands_registered::
...
check: cargo test --test it run_stop_waits_for_proof::
...
src-tauri/tests/it/run_reaches_the_pump.rs
src-tauri/tests/it/run_commands_registered.rs
