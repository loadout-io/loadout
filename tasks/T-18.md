...
check: cargo test --test it skills_place_destinations::
...
check: cargo test --test it skills_place_emit::
...
check: cargo test --test it skills_place_validate::
...
check: cargo test --test it skills_place_plan::
...
check: cargo test --test it skills_place_discovery::
...
check: cargo test --test it skills_place_remove::
...
src-tauri/tests/it/skills_place_destinations.rs
src-tauri/tests/it/skills_place_emit.rs
src-tauri/tests/it/skills_place_validate.rs
src-tauri/tests/it/skills_place_plan.rs
src-tauri/tests/it/skills_place_discovery.rs
src-tauri/tests/it/skills_place_remove.rs-->
