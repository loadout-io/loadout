...
async fn one_run(
    ...
    // ani jedna asercja tego kryterium nie wie o tej zmianie, bo sądzi ono odmowę i to, czego
    // odmowa NIE zostawiła na dysku, a nie wiersze. Kanał do okna jest czarną dziurą z tego
    // samego powodu.
