...
impl AgentDriver for CodexDriver {
    ...
    /// Ten sam adapter, co u Claude'a, nad tym samym rdzeniem (niezmiennik 23): drugi vendor
    /// nie ma prawa mieć drugiego zdania o tym, co znaczy „ta aplikacja odpowiada".
