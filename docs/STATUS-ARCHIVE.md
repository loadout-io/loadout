# Stan budowy — archiwum

Wpisy starsze niż trzy ostatnie. Wydzielone 2026-09-02 (R-8): `STATUS.md` miał 225 KB
i 3237 linii, a `.claude/commands/build.md` kazał czytać go **jako pierwszy** — czyli
każda sesja orchestratora zaczynała od ~65 tys. tokenów historii zamkniętych zadań.
Nic tego pliku nie parsuje; jest do czytania oczami, kiedy szukasz, dlaczego coś jest
jak jest.
